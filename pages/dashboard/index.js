...
import PublishRequest from '../../components/Dashboard/PublishRequest'
                ...
                <div className="createBox"  >
                        ...
                        <Tabs>
                          <TabList style={{margin:"0px"}}>
                            ...
                            <Tab>{objTrans.account}</Tab>

                            <Tab>{objTrans.collections}</Tab>


                            <Tab>{objTrans.items}</Tab>

                            <Tab style={{float:"right"}}>{objTrans.publishRequests}</Tab>

                          </TabList>

                          

                          <TabPanel style={{background:"#fff", margin:'0px', color:"#000"}}> 
                            <MyProfile /> 
                          </TabPanel>
