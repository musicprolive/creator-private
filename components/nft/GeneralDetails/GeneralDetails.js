...
const style = {
  wrapper: `flex`,
  infoContainer: `h-36 flex flex-col flex-1 justify-between mb-6 mt-5`,
  accent: `text-[#2081e2]`,
  ...
  likeIcon: `mr-1`,
  actionButtonsContainer: `w-44 md:mt-14 mt-0`,
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Mars Explore</div>
        <div className={style.nftTitle}>{selectedNft?.name}</div>
        <div className={style.otherInfo}>
          <div className={style.ownedBy}>
            Owned by <span className={style.accent}>creatorPRO</span>
          </div>
          <div className={style.likes}>
            <AiFillHeart className={style.likeIcon} /> 1.2K favorites
          </div>
        </div>
      </div>
